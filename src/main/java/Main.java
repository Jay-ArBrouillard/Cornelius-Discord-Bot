...
public class Main {
    ...
    public static void main(String[] args) throws LoginException, InterruptedException {
        String token = "NjkzMjgyMDk5MTY3NDk0MjI1.Xn6zRQ.OYhKF7U55uOHMSVicM8I7KOoMpE";//System.getenv("TOKEN");
        ...
        String calendarApiKey = "y";//System.getenv("HOLIDAY_API_KEY");
        String unsplashAccessKey = "z";//System.getenv("UNSPLASH_ACCESS_KEY");
