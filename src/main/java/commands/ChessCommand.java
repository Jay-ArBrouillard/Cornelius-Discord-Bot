...
public class ChessCommand {
    ...
    private static String[][] getAIList() {
        return new String[][]{
                ...
                {"693282099167494225AndyRO4", "Andy"},
                ...
                {"693282099167494225DoryRO4", "Dory"},
                ...
                {"693282099167494225HennyRO4", "Henny"},
                {"693282099167494225HelplessRO4", "Helpless"},
                {"693282099167494225KinghunterRO4", "Kinghunter"},
                {"693282099167494225LarsenRO4", "Larsen"},
                {"693282099167494225MarkRO4", "Mark"},
                {"693282099167494225MarshallRO4", "Frank Marshall"},
                ...
                {"693282099167494225APatrickRO4", "Patrick"},
