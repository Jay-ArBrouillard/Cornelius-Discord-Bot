...
public class AmoebaClient extends BaseAiClient{
    private Amoeba engine;

    public AmoebaClient(Variant variant, String filePath, Set<Option> options) throws IOException {
    ...
    public static class Builder {
        ...
        private String path = "bin/amoeba_3_2_linux";

        public final AmoebaClient.Builder setVariant(Variant v) {
            variant = v;
            return this;
        }
        ...
        public final AmoebaClient build() throws IOException {
            return new AmoebaClient(variant, path, options);
        }
    }
}
