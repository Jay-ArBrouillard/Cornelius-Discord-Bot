...
public class Arasan extends UCIEngine {
    public Arasan(Variant variant, String filePath, Option... options) throws IOException {
        super(variant, filePath, "Arasan 22.1", options);
    }
